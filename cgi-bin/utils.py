...
# """ Provides a connection to mongoDB database Returns: Object: A handle to a mongoDB database """
...
#	        raise Exception("Problem connecting to the database!") # if we have a mongo client... 
 #      	else:
...
#	     sup`plied in data list.

#	     Input params: temp_path:
#		 the path to the template file
#		 data: optional list of data values 
#		Returns: String: A formatted string of HTML """
	#try:
